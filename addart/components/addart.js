...
var PrefsBranch = prefObj.getBranch("add-art.org.prefs.");
// The version services gives us access to versions defined in install.rdf
...
function Init() {
	var lastVersion = prefs.getCharPref("currentVersion");
